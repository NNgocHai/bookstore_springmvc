...
(
     ...
     ngaydat TIMESTAMP,
     tongtien INT,
	 tinhtrang NVARCHAR(10) CONSTRAINT DH_activeDH_CHK CHECK (tinhtrang IN ('Đã giao', 'Chưa giao')),
...
INSERT INTO DONHANG(ma_Customer, diachi, sdt, tongtien, ngaydat, tinhtrang)
VALUES ('3', 'KTX Khu D1', '0987935915', '190000', '2020-12-05', 'Đã giao');
INSERT INTO DONHANG(ma_Customer, diachi, sdt, tongtien, ngaydat, tinhtrang)
VALUES ('1', 'Xuân Thọ - Đà Lạt', '0368103208', '135000', '2020-12-04', 'Chưa giao');
INSERT INTO DONHANG(ma_Customer, diachi, sdt, tongtien, ngaydat, tinhtrang)
VALUES ('3', 'Bến Tre', '0327300035', '1595000', '2020-12-06', 'Đã giao');
